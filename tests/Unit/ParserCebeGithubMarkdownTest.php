...
class ParserCebeGithubMarkdownTest extends TestCase
{
    /**
     * Markdown Parser
     * @var string PSR_CLASS
     */
    const PSR_CLASS = \cebe\markdown\GithubMarkdown::class;

    /**
     * Markdown Parser id
     * @var string PSR_CLASS_ID
     */
    const PSR_CLASS_ID = 'github';
    ...
    public function markdownConfig ()
    {
        ...
        $this->parser->setConfig('enableNewlines', false)
            ->will(function () use ($parserIns, $markdown) {
                return $parserIns->setConfig('enableNewlines', false)->parse($markdown);
            })
            ->shouldBeCalled();

        $this->assertEquals(
                $expected,
                $this->parser->reveal()->setConfig('enableNewlines', false)
        );
    }
    ...
    public function markdownConfigChange ()
    {
        ...
        $this->assertEquals(
                $expected,
                $parserIns->setConfig('enableNewlines', false)->parse($markdown)
        );
        ...
        $this->parser->setConfig('enableNewlines', true)
            ->will(function () use ($parserIns, $markdown) {
                return $parserIns->setConfig('enableNewlines', true)->parse($markdown);
            })
            ->shouldBeCalled();

        $this->assertEquals(
                $expected,
                $this->parser->reveal()->setConfig('enableNewlines', true)
        );
    }
    ...
    public function appServiceProviderMarkdownConfig ()
    {
        ...
        $this->assertEquals(
                $expected,
                app('Tomakee\Markdown\Parser')->setConfig('enableNewlines', false)->parse($markdown)
        );
    }
    ...
    public function appServiceProviderMarkdownConfigChange ()
    {
        ...
        $this->assertEquals(
                $expected,
                app('Tomakee\Markdown\Parser')->setConfig('enableNewlines', true)->parse($markdown)
        );
    }
    ...
    public function appServiceProviderBindedMarkdownConfig ()
    {
        ...
        $this->assertEquals(
                $expected,
                app('markdown')->setConfig('enableNewlines', false)->parse($markdown)
        );
    }
    ...
    public function appServiceProviderBindedMarkdownConfigChange ()
    {
        ...
        $this->assertEquals(
                $expected,
                app('markdown')->setConfig('enableNewlines', true)->parse($markdown)
        );
    }
    ...
    public function facadeMarkdownConfig ()
    {
        ...
        $this->assertEquals(
                $expected,
                Markdown::setConfig('enableNewlines', false)->parse($markdown)
        );
    }
    ...
    public function facadeMarkdownConfigChange ()
    {
        ...
        $this->assertEquals(
                $expected,
                Markdown::setConfig('enableNewlines', true)->parse($markdown)
        );
    }
    ...
    public function helperMarkdownConfig ()
    {
        ...
        $this->assertEquals(
                $expected,
                markdown_config('enableNewlines', false)->parse($markdown)
        );
    }
    ...
    public function helperMarkdownConfigChange ()
    {
        ...
        $this->assertEquals(
                $expected,
                markdown_config('enableNewlines', true)->parse($markdown)
        );
    }
}
